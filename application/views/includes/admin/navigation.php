...
<div class="navbar navbar-inverse " id="adminnav">
  ...
  <ul class="nav navbar-nav">
   ...
   <li><a href="<?php echo base_url()?>dashboard_admin">Dashboard</a></li>
   <li><a href="<?php echo base_url()?>users_admin">View Users</a></li>
   <li><a href="<?php echo base_url()?>approvers_admin">View Approvers</a></li>
   <li><a href="<?php echo base_url()?>approvals_admin">View Approvals</a></li>
  </ul>
</div>
<!-- #header ends -->
